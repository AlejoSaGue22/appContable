...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, HeaderTitlePageComponent, RouterLink],
    templateUrl: './antiguedad.component.html',
})
export class AntiguedadComponent implements OnInit {
    headTitle = signal<HeaderInput>({ title: 'Vencimiento de Cartera', slog: 'Análisis de vencimientos por tramos de tiempo' });
