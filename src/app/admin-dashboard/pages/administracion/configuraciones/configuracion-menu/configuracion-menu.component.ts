...
import { HeaderTitlePageComponent, HeaderInput } from '../../../../components/header-title-page/header-title-page.component';
  ...
  menuSections = [
    {
      ...
      description: 'Configura la información de tu empresa y adapta el sistema a tu negocio.',
      options: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Parametrización contable', route: 'parametrizacion-contable' },
