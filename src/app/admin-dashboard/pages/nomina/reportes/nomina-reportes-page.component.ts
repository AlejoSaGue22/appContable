    ...
    <div class="p-6 space-y-6">
      <header-title-page
        [titleHead]="{
          ...
          slog: 'Costos, comparativos y análisis de aportes',
        }"
      >
      </header-title-page>
      ...
      <!-- Tabs -->
      <div
        class="flex items-center p-1 bg-gray-100/50 backdrop-blur-md rounded-2xl w-fit flex-wrap gap-1"
      >
        <button
          (click)="tab.set('costos-centro-costo')"
          [class]="
            tab() === 'costos-centro-costo'
      ...
      <!-- Filtros -->
      <div
        class="bg-white/70 backdrop-blur-xl rounded-2xl shadow-sm border border-gray-100/50 p-6"
      >
        @if (tab() === 'costos-centro-costo' || tab() === 'costos-cargo') {
          <div class="flex flex-col md:flex-row md:items-end gap-6">
            <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div class="space-y-2">
                <label class="font-medium text-gray-400 ml-1"
                  >Fecha Inicio</label
                >
                <input
                  type="date"
          ...
          <div class="flex flex-col md:flex-row md:items-end gap-6">
            <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div class="space-y-2">
                ...
                <select
                  [(ngModel)]="periodo1Id"
                  class="block w-full px-4 py-2.5 bg-gray-50/50 border border-gray-100 rounded-xl text-sm"
                >
            ...
            <button
              (click)="generar()"
              [disabled]="loading() || !periodo1Id || !periodo2Id"
              class="h-[36px] px-4 bg-slate-900 hover:bg-slate-700 cursor-pointer text-white text-sm font-bold rounded-xl transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center min-w-[160px]"
            >
              Comparar
            </button>
        ...
        @if (tab() === 'resumen-aportes') {
          <div class="flex flex-col md:flex-row md:items-end gap-6">
            ...
            <button
              (click)="generar()"
              [disabled]="loading() || !periodoAportesId"
              class="h-[36px] px-4 bg-slate-900 hover:bg-slate-700 cursor-pointer text-white text-sm font-bold rounded-xl transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center min-w-[160px]"
            >
              Consultar
            </button>
          ...
          @switch (tab()) {
                ...
                <div class="overflow-x-auto rounded-xl border border-slate-200">
                  <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100">
                      @for (
                        r of costosData.data;
                        track r.centroCostoId || $index
                      ) {
                        <tr class="hover:bg-slate-50 transition-colors">
                          ...
                          <td class="px-4 py-3 font-mono text-right">
                            {{ r.totalDevengado | currency: '' : '' : '1.0-0' }}
                          </td>
                          <td class="px-4 py-3 font-mono text-right">
                            {{ r.totalAportes | currency: '' : '' : '1.0-0' }}
                          </td>
                          <td class="px-4 py-3 font-mono text-right">
                            {{
                              r.totalProvisiones | currency: '' : '' : '1.0-0'
                            }}
                          </td>
                          <td class="px-4 py-3 font-mono text-right font-bold">
                            {{ r.totalCosto | currency: '' : '' : '1.0-0' }}
                          </td>
                        </tr>
                      }
                    </tbody>
                    <tfoot class="bg-slate-100 font-bold">
                      <tr>
                        ...
                        <td class="px-4 py-3 text-right">
                          {{ costosData.totales.empleados }}
                        </td>
                        <td class="px-4 py-3 font-mono text-right">
                          {{
                            costosData.totales.totalDevengado
                              | currency: '' : '' : '1.0-0'
                          }}
                        </td>
                        <td class="px-4 py-3 font-mono text-right">
                          {{
                            costosData.totales.totalAportes
                              | currency: '' : '' : '1.0-0'
                          }}
                        </td>
                        <td class="px-4 py-3 font-mono text-right">
                          {{
                            costosData.totales.totalProvisiones
                              | currency: '' : '' : '1.0-0'
                          }}
                        </td>
                        <td class="px-4 py-3 font-mono text-right">
                          {{
                            costosData.totales.totalCosto
                              | currency: '' : '' : '1.0-0'
                          }}
                        </td>
                      </tr>
              ...
              @if (comparativoData) {
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div
                    *ngFor="
                      let p of [
                        comparativoData.periodo1,
                        comparativoData.periodo2,
                      ];
                      let i = index
                    "
                  ...
                  >
                    ...
                    <div class="space-y-2 text-sm">
                      <div class="flex justify-between">
                        <span class="text-slate-500">Empleados:</span
                        ><span class="font-mono font-bold">{{
                          p.empleados
                        }}</span>
                      </div>
                      <div class="flex justify-between">
                        <span class="text-slate-500">Devengado:</span
                        ><span class="font-mono">{{
                          p.totalDevengado | currency: '' : '' : '1.0-0'
                        }}</span>
                      </div>
                      <div class="flex justify-between">
                        <span class="text-slate-500">Deducciones:</span
                        ><span class="font-mono">{{
                          p.totalDeducciones | currency: '' : '' : '1.0-0'
                        }}</span>
                      </div>
                      <div class="flex justify-between">
                        <span class="text-slate-500">Neto a Pagar:</span
                        ><span class="font-mono font-bold">{{
                          p.totalNeto | currency: '' : '' : '1.0-0'
                        }}</span>
                      </div>
                      <div class="flex justify-between">
                        <span class="text-slate-500">Aportes Empresa:</span
                        ><span class="font-mono">{{
                          p.totalAportes | currency: '' : '' : '1.0-0'
                        }}</span>
                      </div>
                      <div class="flex justify-between">
                        <span class="text-slate-500">Provisiones:</span
                        ><span class="font-mono">{{
                          p.totalProvisiones | currency: '' : '' : '1.0-0'
                        }}</span>
                      </div>
                ...
                @if (comparativoData.detalleEmpleados?.length) {
                  <h4 class="font-bold text-slate-600 mb-3">
                  ...
                  >
                    <table class="w-full text-sm">
                      ...
                      <tbody class="divide-y divide-slate-100">
                        @for (
                          d of comparativoData.detalleEmpleados;
                          track d.empleadoId
                        ) {
                          <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-4 py-3 font-mono text-right">
                              {{
                                d.periodo1.devengado
                                  | currency: '' : '' : '1.0-0'
                              }}
                            </td>
                            <td class="px-4 py-3 font-mono text-right">
                              {{
                                d.periodo2?.devengado
                                  | currency: '' : '' : '1.0-0'
                              }}
                            </td>
                            <td
                              class="px-4 py-3 font-mono text-right"
                              [class.text-green-600]="
                                d.variacion !== null && d.variacion >= 0
                              "
                              [class.text-red-600]="
                                d.variacion !== null && d.variacion < 0
                              "
            ...
            @case ('resumen-aportes') {
              @if (aportesData) {
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  ...
                  >
                    ...
                    <p class="text-2xl font-bold text-blue-700">
                      {{
                        aportesData.totales.totalAportes
                          | currency: '' : '' : '1.0-0'
                      }}
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <p class="text-2xl font-bold">
                      {{ aportesData.totales.totalEmpleados }}
                    </p>
                  </div>
                  <div
                    class="bg-white rounded-xl border border-slate-200 p-4 text-center"
                  >
                    ...
                    <p class="text-2xl font-bold text-emerald-700">
                      {{
                        aportesData.totales.totalDevengado
                          | currency: '' : '' : '1.0-0'
                      }}
                    </p>
                  </div>
                ...
                <div
                  class="overflow-x-auto rounded-xl border border-slate-200 mb-6"
                >
                  <table class="w-full text-sm">
                    <thead
                      class="bg-slate-50 text-slate-600 text-xs font-bold uppercase "
                    ...
                    <tbody class="divide-y divide-slate-100">
                      @for (r of aportesData.resumen; track r.concepto) {
                        <tr class="hover:bg-slate-50">
                          ...
                          <td class="px-4 py-3 font-mono text-right">
                            {{ r.valor | currency: '' : '' : '1.0-0' }}
                          </td>
                          <td class="px-4 py-3 font-mono text-right">
                            {{
                              (r.valor /
                                (aportesData.totales.totalAportes || 1)) *
                                100 | number: '1.1-1'
                            }}%
                          </td>
                        </tr>
                ...
                <div class="overflow-x-auto rounded-xl border border-slate-200">
                  <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100">
                      @for (
                        d of aportesData.detalleEmpleados;
                        track d.empleadoId
                      ) {
                        <tr class="hover:bg-slate-50">
                          <td class="px-4 py-3 font-medium">
                          ...
                          <td class="px-4 py-3 font-mono text-right">
                            {{ d.ibc | currency: '' : '' : '1.0-0' }}
                          </td>
                          <td class="px-4 py-3 font-mono text-right">
                            {{
                              d.totalAportesEmpleado
                                | currency: '' : '' : '1.0-0'
                            }}
                          </td>
                        </tr>
...
export class NominaReportesPageComponent {
  ...
  generar() {
    ...
    switch (this.tab()) {
      case 'costos-centro-costo':
        this.nominaService
          .getReporteCostosCentroCosto(this.fechaInicio, this.fechaFin)
          .subscribe({
            next: (r) => {
              this.costosData = r;
              this.data.set(r);
            ...
            error: () => {
              this.loading.set(false);
              this.notification.error('Error al cargar reporte');
            },
          });
        break;
      ...
      case 'costos-cargo':
        this.nominaService
          .getReporteCostosCargo(this.fechaInicio, this.fechaFin)
          .subscribe({
            next: (r) => {
              this.costosData = r;
              this.data.set(r);
      ...
      case 'comparativo':
        this.nominaService
          .getReporteComparativo(this.periodo1Id, this.periodo2Id)
          .subscribe({
            next: (r) => {
              this.comparativoData = r;
              this.data.set(r);
              this.loading.set(false);
            },
            error: () => {
      ...
      case 'resumen-aportes':
        this.nominaService
          .getReporteResumenAportes(this.periodoAportesId)
          .subscribe({
            next: (r) => {
              this.aportesData = r;
              this.data.set(r);
  ...
  exportarExcel() {
    ...
    if (this.costosData) {
      const field =
        this.tab() === 'costos-centro-costo'
          ? 'centroCostoNombre'
          : 'cargoNombre';
      const label =
        this.tab() === 'costos-centro-costo' ? 'Centro Costo' : 'Cargo';
      rows = [
        ...d.data.map((r: any) => ({
          [label]: r[field],
        ...
        {
          [label]: 'TOTALES',
          Empleados: d.totales.empleados,
          Devengado: d.totales.totalDevengado,
          Aportes: d.totales.totalAportes,
          Provisiones: d.totales.totalProvisiones,
          'Costo Total': d.totales.totalCosto,
        },
      ];
      ...
      rows = [
        {
          Concepto: 'Empleados',
          [`${d.periodo1.nombre}`]: d.periodo1.empleados,
          [`${d.periodo2.nombre}`]: d.periodo2.empleados,
        },
        {
          Concepto: 'Devengado',
          [`${d.periodo1.nombre}`]: d.periodo1.totalDevengado,
          [`${d.periodo2.nombre}`]: d.periodo2.totalDevengado,
        },
        {
          Concepto: 'Deducciones',
          [`${d.periodo1.nombre}`]: d.periodo1.totalDeducciones,
          [`${d.periodo2.nombre}`]: d.periodo2.totalDeducciones,
        },
        {
          Concepto: 'Neto a Pagar',
          [`${d.periodo1.nombre}`]: d.periodo1.totalNeto,
          [`${d.periodo2.nombre}`]: d.periodo2.totalNeto,
        },
        {
          Concepto: 'Aportes Empresa',
          [`${d.periodo1.nombre}`]: d.periodo1.totalAportes,
          [`${d.periodo2.nombre}`]: d.periodo2.totalAportes,
        },
        {
          Concepto: 'Provisiones',
          [`${d.periodo1.nombre}`]: d.periodo1.totalProvisiones,
          [`${d.periodo2.nombre}`]: d.periodo2.totalProvisiones,
        },
        {
          Concepto: 'Costo Empresa',
          [`${d.periodo1.nombre}`]: d.periodo1.costoEmpresa,
          [`${d.periodo2.nombre}`]: d.periodo2.costoEmpresa,
        },
      ];
