        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()" class="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              class="w-full bg-slate-50 text-sm border border-slate-200 rounded-md px-3 py-2.5"
            />
          </div>
          ...
          <div class="flex gap-3 pt-4 border-t border-slate-100">
            <button
              type="button"
              (click)="onClose()"
              class="flex-1 px-4 py-2.5 rounded-xl border border-slate-200 text-slate-600 text-sm font-bold hover:bg-slate-50"
            >
              Cancelar
            </button>
            <button
              ...
              class="flex-1 px-4 py-2.5 rounded-xl bg-blue-600 text-white text-sm font-bold hover:bg-blue-700 disabled:opacity-50"
            >
              Crear Período
            </button>
          </div>
