...
import { NotasAjusteDetailsComponent } from "./notas-ajuste/components/notas-ajuste-details/notas-ajuste-details.component";
...
export const ventasRoutes: Routes = [
    ...
    },
    {
        ...
        component: NotasAjusteDetailsComponent
    },
    {
        path: '**',
