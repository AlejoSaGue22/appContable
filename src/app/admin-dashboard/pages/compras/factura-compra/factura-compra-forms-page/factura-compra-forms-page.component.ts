...
export class FacturaCompraFormsPageComponent implements OnInit {
  ...
  proveedoresList = signal<any[]>([
      { id: '1', nombre: 'Proveedor ABC SAS', identificacion: '900123456' },
      { id: '2', nombre: 'Distribuidora XYZ', identificacion: '800987654' },
      { id: '3', nombre: 'Servicios Logísticos LTDA', identificacion: '900555111' }
  ]);
  
  productosList = signal<any[]>([
     { id: '101', nombre: 'Computador Portátil', codigo: 'CMP-001', precioventa1: 2500000, impuesto: 19 },
     { id: '102', nombre: 'Mouse Inalámbrico', codigo: 'ACC-002', precioventa1: 50000, impuesto: 19 },
     { id: '103', nombre: 'Servicio de Mantenimiento', codigo: 'SRV-001', precioventa1: 150000, impuesto: 0 },
     { id: '104', nombre: 'Teclado Mecánico', codigo: 'ACC-003', precioventa1: 300000, impuesto: 19 }
  ]);
  ...
  ngOnInit(): void {
    ...
    this.productosItemsForm.get('producto')?.valueChanges.subscribe((prod: any) => {
        if (prod) {
            this.productosItemsForm.patchValue({
                unitPrice: prod.precioventa1,
                iva: prod.impuesto,
                quantity: 1,
                discount: 0
            });
  ...
  addItem() {
      ...
      this.productosItemsForm.reset({ quantity: 1, unitPrice: 0, iva: 0, discount: 0, total: 0 });
  }
  ...
  onProviderSaved(newProvider: any) { // Replace any with proper type
      ...
      this.formCompra.patchValue({ proveedor: newProvider });
