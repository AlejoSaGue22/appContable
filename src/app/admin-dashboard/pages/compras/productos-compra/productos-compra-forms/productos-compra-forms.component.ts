...
export class ProductosCompraFormsComponent {
    ...
    headTitle: HeaderInput = {
            title: 'Registra un producto de compra',
            slog: 'Gestiona la información de tus productos de compra'
    }
      ...
      try {
        ...
        if (this.productosID() == 'new-Item') {
            ...
            if (this.isModal()) {
                ...
                await this.router.navigateByUrl('/dashboard/ventas/products_purchase');  
            }
