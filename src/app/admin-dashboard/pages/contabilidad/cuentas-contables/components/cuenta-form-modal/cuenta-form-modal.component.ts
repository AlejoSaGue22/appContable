...
@Component({
 ...
 <p class="text-xs text-blue-700 font-medium uppercase mb-1">Cuenta Padre</p>
 ...
 <!-- Código -->
 <div class="space-y-1">
 <label class="text-xs font-bold text-gray-600 uppercase ">Código PUC</label>
 ...
 <!-- Nombre -->
 <div class="space-y-1">
 <label class="text-xs font-bold text-gray-600 uppercase ">Nombre de la Cuenta</label>
 ...
 <!-- Descripción -->
 <div class="space-y-1">
 <label class="text-xs font-bold text-gray-600 uppercase ">Descripción (Opcional)</label>
